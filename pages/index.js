...
">Hawai'i and U.S. territories</a>.</h5>
    ...
    <div class="search-row d-flex d-flex-column d-flex-left width-80 padding-bottom">
      <div class="rounded-box input-outer-main padding-horizontal bottom-padding main-btn-height width-75">
        <input id="location-search-input" type="text" class="location-mapper input-inner border-none main-btn-height width-90" autocomplete="off" placeholder="To get started, enter a county or city name" aria-label="To get started, enter a county or city name">
