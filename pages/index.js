...
<body class="h-100">
  ...
  <div class="container-fluid index-page h-100 body-size">
    ...
    <div class="mt-3">
      ...
      <div class="title-subtext p-4 col-12 col-xl-6 rounded-2">
        <span>Explore how climate is projected to change in your county.</span>
      </div>
    </div>
    ...
    <div class="d-flex-column mt-3">
      ...
      <div class="d-flex mb-3 search-input-group rounded-2 border border-1 mt-3 col-12 col-xl-6">
        <input class="form-control location-mapper" type="text" placeholder="To get started, enter a city, county, or other placename" aria-label="Enter county or city name">
        <span class="icon icon-search d-flex align-items-center p-2"></span>
      </div> 
    </div>
    
    <div class="default-cities p-2 col-12 col-xl-6 row m-0 rounded-2"> 
