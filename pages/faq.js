    ...
    <div id="about-text-row" class="padding-vertical width-100" >
      ...
      <div id="standard-body" class="page-text ui-accordion ui-widget ui-helper-reset">
        ...
        <div class="accordion-text">
          <p>
            Climate Explorer is designed to be widely accessible and compatible with most popular, current web browsers, including Chrome, Firefox, Safari, and Edge. Climate Explorer can be viewed on a desktop or laptop computer as well as on mobile devices such as tablets and smartphones devices.
          </p>
        </div>
        <h4>How can I submit questions or comments, or report a bug or broken link? </h4>
        <div class="accordion-text">
          <p>We'd love to hear from you. Please send questions, comments, or suggestions about the Climate Explorer to noaa.toolkit@noaa.gov. Expect a reply within one week.
          </p>
        </div>
        <h4>
        ...
        <div class="accordion-text">
          <p>Yes. The graphs, maps, and text available in the Climate Explorer are considered public information and may be downloaded, reproduced, and distributed freely. If you re-use images and text from the tool, please credit the <strong>U.S. Climate Resilience Toolkit Climate Explorer</strong> as the source.
          </p>
        </div>
        <h4>What is the recommended citation for the information in the Climate Explorer?</h4>
        <div class="accordion-text">
          <p>U.S. Federal Government, 2020: U.S. Climate Resilience Toolkit Climate Explorer. [Online] https://crt-climate-explorer.nemac.org/ Accessed {DATE}.</p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <ul>
            ...
            <li>Projections vary from model to model; the current state of understanding is that the full range of projections selected for this tool represents an estimate for the range of plausible climate futures. Considering the trends and the full range of projections for future scenarios can help users develop a sense of potential future risks.
            </li>
        ...
        <div class="accordion-text">
          ...
          <ul>
            <li>
              First, each global climate model uses a slightly different set of equations to represent Earth's physical processes. Therefore, results from different models show a range of projections at each time step for each scenario. This is the reason Climate Explorer graphs show a band of projected values for each scenario rather than a single line.
            </li>
            <li>
            ...
            <li>
              Third, the statistical downscaling method assumes that the future climate will behave similarly to the historical climate in terms of atmospheric and oceanic circulation patterns, which may not be true at every location.
            </li>
            <li>
              Finally, calculating a single average value for climate variables for each county inevitably also introduces error, in that the average cannot accurately represent every location in the county. The error for any location depends on differences in the environment such as elevation and proximity to lakes, a coast, or mountains.
            </li>
          </ul>
          <p>
            The Climate Explorer's presentation of projections as bands of values gives equal weight to the outputs from each of the 32 models; whichever model
            has the maximum value at any time step is represented at the top of the band and whichever model has the minimum value is represented by the bottom of the band. The weighted average line is calculated by assigning more or less 'weight' to each model based on their independence from the other 32 models and their skill in projecting the observed climate of North America in the recent past. Though the average line is no more likely to be the observed future value than any of the other model's value, it helps define the trend.
          </p>
        </div>
        ...
        <div class="accordion-text">
          <p>
            The modeled data in Local Climate Charts for the contiguous United States are based on statistical downscaling of temperature and precipitation projections from the Coupled Model Intercomparison Project Phase 5 (<a href="https://esgf-node.llnl.gov/projects/cmip5/" target="_blank">CMIP5</a>) using Localized Constructed Analogs (<a href="http://loca.ucsd.edu/" target="_blank">LOCA</a>), provided by David Pierce and Daniel Cayan of the Scripps Institution of Oceanography. The downscaling technique was developed and described by D.W. Pierce, (2014). Climate variables presented in Climate Explorer were derived from LOCA projections of maximum temperature, minimum temperature, and total precipitation. LOCA data for historical and future periods are freely available for the contiguous United States, Southern Canada, and Northern Mexico via Data.gov.
          </p>
          <p>
            For Alaska boroughs, hindcasts and projections are based on results from two climate models (GFDL-CM3 and NCAR-CCSM4). <a href="http://ckan.snap.uaf.edu/dataset/historical-and-projected-dynamically-downscaled-climate-data-for-the-state-of-alaska-and-surrou" target="_blank">Downscaled results for Alaska</a> were produced by the <a href="https://casc.alaska.edu/" target="_blank">Alaska Climate Adaptation and Science Center</a> using the Weather Research and Forecasting (<a href="https://www.mmm.ucar.edu/weather-research-and-forecasting-model">WRF</a>) model (Version 3.5). On local climate charts for Alaska boroughs, actual values from the two climate models have been smoothed by a 10-year rolling average.
          </p>
          <p>
            A gridded observational dataset aggregated by Ben Livneh et al. (2013, 2015) was used to calculate historical averages for the period 1961-1990. Annual observations—shown as dark gray bars in Climate Explorer graphs—extend above or below the 30-year average. Livneh data are freely available via Data.gov.
          </p>
          <p>
            For more details about the tool and its data sources, please see the “About Climate Explorer” section.
          </p>
        </div>
        <h4>What changes were made in the early 2018 update of Climate Explorer?</h4>
        <div class="accordion-text">
          <p>
            See <a href="https://toolkit.climate.gov/content/notice-climate-explorer-users">Notice to Climate Explorer Users</a>
          </p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <p>
            For further information, see <a href="https://tidesandcurrents.noaa.gov/publications/techrpt86_PaP_of_HTFlooding.pdf">Patterns and Projections of High-tide flooding along the U.S. Coastline using a Common Impact Threshold</a>.
          </p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <p>For selected stations, graphs show the observed annual number of days with high tide flooding through 2016, and projections for the annual number of high tide flooding days, for higher and lower emissions scenarios, through 2100 (Sweet et al., 2018).
          </p>
          <p>
            For more information, see <a href="https://tidesandcurrents.noaa.gov/publications/techrpt86_PaP_of_HTFlooding.pdf">Patterns and Projections of High-tide flooding along the U.S. Coastline using a Common Impact Threshold.</a>
          </p>
        </div>
        <h2>
          Considerations for using Climate Explorer
        </h2>
        <h4>Why can I only get county-scale climate projections in Climate Explorer? Where can I get climate projections at higher spatial and temporal resolution?
        </h4>
        <div class="accordion-text">
          <p>
          ...
          <p>
            The Climate Explorer uses the Localized Constructed Analogs (LOCA) downscaled climate and hydrology projections, which are available at 1/16° spatial resolution and daily temporal resolution for the period from 1950 to 2100. (Note: some models stop in 2099.)
          </p>
          <p>
        ...
        <h4>In the "Days of Precipitation Above 1 Inch" charts, why are historical observed values so different from historical modeled values for some counties and not for others?
        </h4>
        <div class="accordion-text">
          <p>
        ...
        <div class="accordion-text">
          <p>
            If you have maps or data that you would like to offer as candidates for inclusion in the Climate Explorer, let us know by emailing noaa.toolkit@noaa.gov. If you would like to add to or evolve the tool's functionality, please note that the code repository for Climate Explorer is freely available on GitHub. Please note: We'd be happy to hear of your efforts to reuse this code, but the Climate Explorer team can not offer technical support for such efforts.
          </p>
        </div>
        <h4>Contact</h4>
        <div class="accordion-text">
          <p>
            If you have questions or comments on the Climate Explorer, please direct them to <a href="mailto:noaa.toolkit@noaa.gov">noaa.toolkit@noaa.gov</a>.
          </p>
        </div>
      </div>
    </div>
