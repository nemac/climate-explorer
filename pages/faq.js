    ...
    <div id="about-text-row" class="padding-vertical width-100" >
      ...
      <div id="standard-body" class="page-text ui-accordion ui-widget ui-helper-reset">
        ...
        <div class="accordion-text">
          <p>
            We'd love to hear from you. Please send questions, comments, or suggestions to <a href="mailto:noaa.toolkit@noaa.gov">noaa.toolkit@noaa.gov</a>. Expect a reply within a few days to one week.
          </p>
        </div>
        ...
        <div class="accordion-text">
          <p>
          Yes. See <a href="https://arcg.is/15mvy80">Using Climate Explorer to get a feel for Future Conditions »</a> 
          </p>
        </div>
        ...
        <div class="accordion-text">
          <p>
            Modeled data for the contiguous United States are based on statistical downscaling of temperature and precipitation projections from the Coupled Model Intercomparison Project Phase 5 (<a href="https://esgf-node.llnl.gov/projects/cmip5/">CMIP5</a>) using Localized Constructed Analogs (<a href="http://loca.ucsd.edu/">LOCA</a>). LOCA data for historical and future periods are freely available for the contiguous United States, Southern Canada, and Northern Mexico via <a href="https://catalog.data.gov/dataset/projected-future-loca-statistical-downscaling-localized-constructed-analogs-statistically-downs">Data.gov</a>.
          </p>
          <p>
          For Alaska boroughs, hindcasts and projections are based on results from two climate models, GFDL-CM3 and NCAR-CCSM4. <a href="http://ckan.snap.uaf.edu/dataset/historical-and-projected-dynamically-downscaled-climate-data-for-the-state-of-alaska-and-surrou">Downscaled results for Alaska</a> were produced by the <a href="https://casc.alaska.edu/">Alaska Climate Adaptation and Science Center</a> using the Weather Research and Forecasting (<a href="https://www.mmm.ucar.edu/weather-research-and-forecasting-model">WRF</a>) model (Version 3.5). On climate graphs for Alaska boroughs, values from the two climate models have been smoothed by a 10-year rolling average.
          </p>
          <p>
          For Hawai’i and U.S. island territories, modeled history and future projections come from CMIP5 global climate model simulations. Projections for individual islands are the average of the three global climate model grid points closest to the geographic center of each island.
          </p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <p>For decisions involving the use of climate model projections, you may want to consider seeking <a href="https://toolkit.climate.gov/#expertise">expertise</a>.</p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <p>To learn more, view <a href="https://link.springer.com/article/10.1007/s10584-013-0906-1">a summary table</a> describing the four RCPs »</p>
        </div>
...
Beyond spatial interpolation and natural interannual variability, other elements of the modeling process introduce margins of uncertainty in climate projections.
        ...
        <div class="accordion-text">
          ...
          <p>Though the two tools have some similarities, the <a href="https://www.emetsoc.org/ems-technology-award-2021-for-geert-jan-van-oldenborgh/">award-winning KNMI Climate Explorer</a> was established more than a decade before the U.S. Climate Resilience Toolkit’s Climate Explorer, and the two are not related. Their developers simply chose the same name for their tools. Climate researchers are one of the main audiences for the KNMI Climate Explorer—data available through the tool is offered in specialized formats that require scientific software.
          </p>
        </div>
        ...
        <div class="accordion-text">
          ...
          <p>
          Downscaled climate projection information is available from other sources at other spatial resolutions for some locations. For example, climate modelers have produced downscaled climate projections at city-scale resolution for some cities, watersheds, national park lands, and other locations. Groups such as USDA's Climate Hubs, NOAA's Regional Integrated Sciences and Assessments (RISA) groups, and Landscape Conservation Cooperatives may have, or may be able to point you to, people or groups who have expertise in developing or interpreting downscaled climate projections at other spatial scales. You may also be able to find climate model expertise near your location on the Climate Resilience Toolkit's <a href="https://toolkit.climate.gov/help/partners">Find Experts</a> map.
           </p>
        </div>
        ...
        <div class="accordion-text">
            <p>If you have maps or data that you would like to offer as candidates for inclusion in the Climate Explorer, let us know by emailing <a href="mailto:noaa.toolkit@noaa.gov">noaa.toolkit@noaa.gov</a>. If you would like to add to or evolve the tool's functionality, please note that the code repository for Climate Explorer is freely available on GitHub. Please note: We'd be happy to hear of your efforts to reuse this code, but the Climate Explorer team can not offer technical support for such efforts.
            </p>
        </div>
