    ...
    <div id="about-text-row" class="padding-vertical width-100" >
      ...
      <div id="standard-body" class="page-text">
        ...
        <dl>
          ...
          <dd>Total number of days per year when the highest temperature of the day is greater than 50, 60, 70, or 80 in Alaska, or greater than 90, 95, 100, or 105°F in the contiguous United States.</dd>
          ...
          <dt>Emissions</dt>
          <dd>Exhaust from burning coal, oil, and/or natural gas. In general, the word refers to the full range of human processes that release heat-trapping gases into the atmosphere.</dd>

          <dt>Ensemble</dt>
          <dd>The range of results from a group of climate models all running the same experiment.</dd>

          <dt>Freezing degree days</dt>
          <dd>A measure that reflects how cold it is and the length of time it is cold. A location's number of freezing degree days can help predict the formation of ice on the surface of lakes or the sea. Freezing degree days are calculated by multiplying the average number of degrees below freezing by the number of days in the period.</dd>
          ...
          <dd>A measure that reflects the amount of energy available for melting ice over time. Thawing degree days are calculated by multiplying the average number of degrees above freezing by the number of days in the period.</dd>
