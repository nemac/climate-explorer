  ...
  <div id="about-viewport" class="padding-horizontal d-flex d-flex-column">
    ...
    <div id="about-text-row" class="padding-vertical width-100" >
      ...
      <div id="standard-body" class="page-text">
        ...
        <p>
         The Climate Explorer provides interactive graphs and maps showing past and projected climate conditions for counties and county-equivalents across the United States. Built to support the <a href="https://toolkit.climate.gov/" target="_blank>">U.S. Climate Resilience Toolkit</a>, the tool helps people explore projected future climate conditions that may put people, property, and other assets at risk.
        </p>
        <p>
          <a target="_blank" href="https://www.fernleafinteractive.com/">FernLeaf Interactive</a> and the <a target="_blank" href="https://nemac.unca.edu/">National Environmental Modeling and Analysis Center (NEMAC)</a> at the University of North Carolina Asheville built the Climate Explorer’s graphing modules; they also built the interactive map modules which are powered by <a target="_blank" href="http://www.arcgis.com/">ArcGIS</a>. All requests for historic and projected climate data are powered by ACIS web services. <a target="_blank" href="https://habitatseven.com/">Habitat Seven</a> led the initial design of the Climate Explorer interface. If you have questions or comments about the Climate Explorer, please direct them to <a target="_blank" href="mailto:noaa.toolkit@noaa.gov">noaa.toolkit@noaa.gov</a>.
        </p>
        <p>
          <hr>
        </p>
        ...
        <h3>Observations</h3>
        <p>
          For the contiguous United States, graphs and maps for 1950 through 2013 show averages of observations recorded at individual climate and weather stations. Station data for temperature and precipitation were interpolated and stored as a gridded observational dataset prepared by Livneh et al. (2013, 2015). This dataset is also used to calculate observed differences from averages for the period 1961-1990. Data are <a target="_blank" href="https://catalog.data.gov/dataset/a-spatially-comprehensive-hydrologic-model-based-data-set-for-mexico-the-u-s-and-sout-1950-2013">available via Data.gov</a>.
        </p>
        <h3>Modeled History and Projections</h3>
        <p>
          Graphs in Climate Explorer show results generated by global climate models for the Coupled Model Intercomparison Project Phase 5 (CMIP5). For the contiguous United States, the climate model data were statistically downscaled using the Localized Constructed Analogs method (<a target="_blank" href="http://loca.ucsd.edu/">LOCA</a>; Pierce et al. 2014). For Alaska, data are from Scenarios Network for Alaska + Arctic Planning (SNAP). For Hawai’i and U.S. territories, data are from global climate model simulations: projections for individual islands were calculated as the average of the three grid points closest to the geographic center of each island..
        </p>
        <p>
          For the contiguous United States, Hawai’i, and U.S. territories, Climate Explorer shows projections for two potential futures, labeled Lower emissions and Higher emissions; they represent scenarios RCP 4.5 and RCP 8.5, respectively. Projections for Alaska are only for Higher emissions. <a target="_blank" href="https://link.springer.com/article/10.1007/s10584-011-0148-z"> Learn more about Representative Concentration Pathways (RCPs) »</a>
        </p>
        <p>
        ...
        <h3>Stations</h3>
        <p>
          Temperature and precipitation observations and Climate Normals displayed in graphs for individual stations are from the <a target="_blank" href="https://www.ncdc.noaa.gov/data-access/land-based-station-data/land-based-datasets/global-historical-climatology-network-ghcn">Global Historical Climatology Network-Daily (GHCN-D)</a> database. These data are accessed via the NOAA Regional Climate Centers' Applied Climate Information System (ACIS) <a target="_blank" href="http://grid2.rcc-acis.org/GridData">data server</a>.
        </p>
        <p>
          Historical observations and future projections of coastal high tide flooding are from <a target="_blank" href="https://tidesandcurrents.noaa.gov/publications/techrpt86_PaP_of_HTFlooding.pdf">NOAA Technical Report NOS CO-OPS 086 - Patterns and Projections of High-tide Flooding</a>.
        </p>
        <h3>Credits & Acknowledgments</h3>
        <p>
          The U.S. Climate Resilience Toolkit and Climate Explorer are managed by <a target="_blank" href="https://cpo.noaa.gov/">NOAA's Climate Program Office</a>, and hosted by the <a target="_blank" href="https://nemac.unca.edu/">National Environmental Modeling and Analysis Center (NEMAC)</a> at the University of North Carolina Asheville.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Livneh, B., E. A. Rosenberg, C. Lin, B. Nijssen, V. Mishra, K. M. Andreadis, E. P. Maurer, and D. P. Lettenmaier (2013), A long-term hydrologically based dataset of land surface fluxes and states for the conterminous United States: Update and extensions, <em>J. Clim.</em>, 26(23), 9384–9392, doi <a target="_blank" href="http://dx.doi.org/10.1175/JCLI-D-12-00508.1">10.1175/JCLI-D-12-00508.1</a>.
          </li>
          <li>
            Livneh, B., Bohn, T.J., Pierce, D.W., Munoz-Arriola, F., Nijssen, B., Vose, R., Brekke, L. 2015. A spatially comprehensive, hydrometeorological data set for Mexico, the U.S., and Southern Canada 1950–2013. <em>Scientific Data</em> 2:150042. doi: <a target="_blank" href="http://dx.doi.org/10.1038/sdata.2015.42">10.1038/sdata.2015.42</a>.
          </li>
          <li>
            Pierce, D. W., D. R. Cayan, and B. L. Thrasher, 2014: Statistical Downscaling Using Localized Constructed Analogs (LOCA). <em>Journal of Hydrometeorology</em>, volume 15, 2558-2585. doi: <a target="_blank" href="https://doi.org/10.1175/JHM-D-14-0082.1">10.1175/JHM-D-14-0082.1</a>.
          </li>
          <li>
            Sanderson, B.M. and M.F. Wehner, 2017: Model weighting strategy. In: Climate Science Special Report: Fourth National Climate Assessment, Volume I [Wuebbles, D.J., D.W. Fahey, K.A. Hibbard, D.J. Dokken, B.C. Stewart, and T.K. Maycock (eds.)]. U.S. Global Change Research Program, Washington, DC, USA, pp. 436-442, doi: <a target="_blank" href="http://dx.doi.org/10.7930/J06T0JS3">10.7930/J06T0JS3</a>.
          </li>
          <li>
            Sweet, W.V.. G. Dusek, J. Obeysekera, and J. Marra (2018): <a target="_blank" href="https://tidesandcurrents.noaa.gov/publications/techrpt86_PaP_of_HTFlooding.pdf">NOAA Technical Report NOS CO-OPS 086 - Patterns and Projections of High-tide Flooding</a>.
          </li>
          <li>
            Sweet, W.V. and J. Park (2014): From the extreme and the mean: Acceleration and tipping point of coastal inundation from sea level rise. Earth Futures, 2 579-600. doi: <a target="_blank" href="https://doi.org/10.1002/2014EF000272">10.1002/2014EF000272</a>.
          </li>
          <li>
            Taylor, K.E., R.J. Stouffer, and G.A. Meehl, 2012: An Overview of CMIP5 and the Experiment Design. <em>Bull. Amer. Meteor. Soc.,</em> 93, 485–498, doi: <a target="_blank" href="https://doi.org/10.1175/BAMS-D-11-00094.1">10.1175/BAMS-D-11-00094.1</a>.
          </li>
          <li>
