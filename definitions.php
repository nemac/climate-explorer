...
<head>
  ...
  <meta property="og:url" content="/definitions.php" />
    ...
    <section id="standard-body" class="page-text">
      ...
      <dl>
        ...
        <dd>Lines within the red and blue bands highlight the weighted mean of all projections at each time step. Projections are weighted according to model
          independance and skill (see Sanderson and Wehner, 2017). Though the weighted average is no more or less likely to predict actual values in the future
        ...
        <dd>A measure reflecting when conditions are right for corn to develop (between 50 and 86°F). Values are calculated using the standard calculation for
          growing degree days, but maximum or minumum temperatures less than 50°F are set to 50°F and maximum or minimum temperatures > 86°F are set to 86°F.
        </dd>
