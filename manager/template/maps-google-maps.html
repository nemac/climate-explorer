...
<html class="fixed">
	<head>
		...
		<title>Basic Maps | Porto Admin - Responsive HTML5 Template 1.4.0</title>
	...
	<body>
						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Static</h2>
								</header>
								<div class="panel-body">
									<div id="gmap-static" style="height: 500px; width: 100%;"></div>
								</div>
							</section>
						</div>
						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">With Context Menu</h2>
								</header>
								<div class="panel-body">
									<div id="gmap-context-menu" style="height: 500px; width: 100%;"></div>
								</div>
							</section>
						</div>
					</div>
						...
						<div class="col-xs-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Street View</h2>
								</header>
								<div class="panel-body">
		...
		<!-- Specific Page Vendor -->		<script src="http://maps.google.com/maps/api/js?sensor=false"></script>		<script src="assets/vendor/gmaps/gmaps.js"></script>
