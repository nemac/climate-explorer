...
<html class="fixed">
	<head>
		...
		<title>Accordions | Porto Admin - Responsive HTML5 Template 1.4.0</title>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h2 class="pb-lg">One Toggle Open At A Time</h2>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="panel-group" id="accordionWarning">
								<div class="panel panel-accordion panel-accordion-warning">
									<div class="panel-heading">
										<h4 class="panel-title">
					...
					<div class="row mt-lg pt-lg">
						<div class="col-md-4">
							<div class="panel-group" id="accordionDanger">
								<div class="panel panel-accordion panel-accordion-danger">
									<div class="panel-heading">
										<h4 class="panel-title">
						...
						<div class="col-md-4">
							<div class="panel-group" id="accordionInfo">
								...
								<div class="panel panel-accordion panel-accordion-info">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionInfo" href="#collapseInfoTwo">
												 Praesent id enim
											</a>
										</h4>
									</div>
								...
								<div class="panel panel-accordion panel-accordion-info">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionInfo" href="#collapseInfoThree">
												Lorem ipsum dolor
											</a>
										</h4>
									</div>
						...
						<div class="col-md-4">
							<div class="panel-group" id="accordionDark">
								<div class="panel panel-accordion panel-accordion-dark">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionDark" href="#collapseDarkOne">
												Donec tellus massa
											</a>
										</h4>
									</div>
									<div id="collapseDarkOne" class="accordion-body collapse">
										<div class="panel-body">
											Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien. Praesent id enim sit amet odio vulputate eleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien. Praesent id enim sit amet odio vulputate eleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien. Praesent id enim sit amet odio vulputate eleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien. Praesent id enim sit amet odio vulputate eleifend in in tortor. Donec tellus massa.
										</div>
									</div>
								...
								<div class="panel panel-accordion panel-accordion-dark">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionDark" href="#collapseDarkTwo">
												 Praesent id enim
											</a>
										</h4>
									</div>
									<div id="collapseDarkTwo" class="accordion-body collapse">
										<div class="panel-body">
											Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.
										</div>
									</div>
								...
								<div class="panel panel-accordion panel-accordion-dark">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionDark" href="#collapseDarkThree">
												Lorem ipsum dolor
											</a>
										</h4>
									</div>
									<div id="collapseDarkThree" class="accordion-body collapse">
										<div class="panel-body">
											Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.
										</div>
									</div>
