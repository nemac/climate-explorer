...
<html class="fixed">
	<head>
		...
		<title>Vector Maps | Porto Admin - Responsive HTML5 Template 1.4.0</title>
		...
		<!-- Specific Page Vendor CSS -->		<link rel="stylesheet" href="assets/vendor/jqvmap/jqvmap.css" />
