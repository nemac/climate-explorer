...
<html class="fixed">
	<head>
		...
		<title>Extra | Porto Admin - Responsive HTML5 Template 1.4.0</title>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Arrows</h2>
									<p class="panel-subtitle">Arrows can be used to highlight other elements.</p>
								</header>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Responsive embed</h2>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-8">
											<h5 class="text-semibold text-dark text-uppercase">16:9 aspect ratio</h5>
											<div class="embed-responsive embed-responsive-16by9">
												<iframe class="embed-responsive-item" src="//player.vimeo.com/video/67957799"></iframe>
											</div>
										</div>
										<div class="col-md-4">
											<h5 class="text-semibold text-dark text-uppercase">4:3 aspect ratio</h5>
