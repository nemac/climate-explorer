...
<html class="fixed">
	<head>
		...
		<title>Portlets | Porto Admin - Responsive HTML5 Template 1.4.0</title>
	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<h3 class="mt-none">Portlets</h3>
					<p>
						Here you can drag and drop panels. Their state is automatically saved, refresh to restore the saved state.
					</p>
					<p>
		...
		<!-- Specific Page Vendor -->		<script src="assets/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>		<script src="assets/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js"></script>		<script src="assets/vendor/store-js/store.js"></script>
