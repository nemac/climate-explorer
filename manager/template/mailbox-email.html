...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<title>E-Mail | Porto Admin - Responsive HTML5 Template 1.4.0</title>
		...
		<!-- Specific Page Vendor CSS -->		<link rel="stylesheet" href="assets/vendor/summernote/summernote.css" />		<link rel="stylesheet" href="assets/vendor/summernote/summernote-bs3.css" />
	...
	<body>
						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="email">
							...
							<div class="inner-body mailbox-email">
								<div class="mailbox-email-header mb-lg">
									...
									<p class="mt-lg mb-none text-md">From <a href="#">Okler Themes</a> to <a href="#">You</a>, started on July, 05, 2014</p>
								</div>
		...
		<!-- Specific Page Vendor -->		<script src="assets/vendor/summernote/summernote.js"></script>
