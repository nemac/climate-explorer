...
<html class="fixed">
	<head>
		...
		<title>Tree View | Porto Admin - Responsive HTML5 Template 1.4.0</title>
		...
		<!-- Specific Page Vendor CSS -->		<link rel="stylesheet" href="assets/vendor/jstree/themes/default/style.css" />
	...
	<body>
		...
		<!-- Specific Page Vendor -->		<script src="assets/vendor/jstree/jstree.js"></script>
