...
<html class="fixed">
	<head>
		...
		<title>Typography | Porto Admin - Responsive HTML5 Template 1.4.0</title>
						...
						<div class="col-md-9">
							<section class="panel">
								<header class="panel-heading">
									...
									<p class="panel-subtitle">All HTML headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>, are available.</p>
								</header>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Paragraphs</h2>
									<p class="panel-subtitle">Make a paragraph stand out by adding lead class, and check out the alternative font style.</p>
								</header>
								<div class="panel-body">
									<p class="lead">Mauris aliquet ultricies ante, non <span class="word-rotate" data-plugin-options='{ "delay": 3000 }'><span class="word-rotate-items"><span>lorem</span>
									<span>ipsum</span><span>dolor</span></span></span>. Sed ultrices pellentesque purus, vulputate.</p>
									...
									<p>Mauris aliquet <span class="highlight">ultricies</span> non faucibus ante gravida sed. Sed ultrices pellentesque purus, vulputate.</p>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<p class="panel-subtitle">Text styles/states can be changed with css classes.</p>
								</header>
								<div class="panel-body">
									<p class="text-muted">
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Drop Caps</h2>
									<p class="panel-subtitle">Dropcaps styles can be changed with css classes.</p>
								</header>
								<div class="panel-body">
									<div class="row">
										<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<p class="drop-caps colored">Pellentesque pellentesque eget tempor tellus. Fusce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus. Fusce lacinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus. Fusce lacinia tempor malesuada.</p>
										</div>
										<div class="col-md-6">
											<p class="drop-caps secundary colored">Pellentesque pellentesque eget tempor tellus. Fusce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus. Fusce lacinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus. Fusce lacinia tempor malesuada.</p>
										</div>
									</div>
								</div>
							</section>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Blockquotes</h2>
									<p class="panel-subtitle">Blockquote styles can be changed with css classes.</p>
								</header>
								<div class="panel-body">
									<blockquote>
									...
									<code>.b-thin</code>
									<blockquote class="b-thin primary">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Duis mollis, est non commodo luctus, nisi erat porttitor ligula integer posuere erat a ante.
										</p>
									</blockquote>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<p class="panel-subtitle">Use the well as a simple effect on an element to give it an inset effect.</p>
								</header>
								<div class="panel-body">
									<div class="well">
						...
						<div class="col-md-3">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Unordered List</h2>
									<p class="panel-subtitle">A list of items in which the order does not explicitly matter.</p>
								</header>
								<div class="panel-body">
									<ul>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Ordered List</h2>
									<p class="panel-subtitle">A list of items in which the order does explicitly matter.</p>
								</header>
								<div class="panel-body">
									<ol>
										<li>Lorem ipsum dolor sit amet.</li>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Unstyled List</h2>
									<p class="panel-subtitle">Remove the default list-style and left margin on list items (immediate children only).</p>
								</header>
								<div class="panel-body">
									<ul class="list-unstyled">
										<li>Lorem ipsum dolor sit amet.</li>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Inline List</h2>
									<p class="panel-subtitle">Place all list items on a single line with display: inline-block; and some light padding.</p>
								</header>
								<div class="panel-body">
