...
<html class="fixed">
	<head>
		...
		<title>Lock Screen | Porto Admin - Responsive HTML5 Template 1.4.0</title>
	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					You can use a lockscreen page (<a href="/pages/lock-screen.html">here</a>),

 					or wait <b>10</b> seconds without moving your mouse and pressing any key, to see lock screen modal.
					<!-- end: page -->
				</section>
			</div>
		...
		<!-- Specific Page Vendor -->		<script src="assets/vendor/jquery-idletimer/dist/idle-timer.js"></script>
