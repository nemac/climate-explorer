...
<html class="fixed">
	<head>
		...
		<title>Scrollable | Porto Admin - Responsive HTML5 Template 1.4.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<p class="mb-lg">Easily add scrollbars in any type of content in the page as shown below:</p>
						...
						<div class="col-md-4">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Panel with Scrollable Content</h2>
								</header>
						...
						<div class="col-md-4">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Slider Always Visible</h2>
								</header>
								<div class="panel-body">
						...
						<div class="col-md-4">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Slider Always Visible and Colored</h2>
								</header>
								<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="text-dark mb-xlg">Scrollable Content + Nested Container</h4>
							...
							<div class="scrollable" data-plugin-scrollable style="height: 500px;">
								<div class="scrollable-content">
									...
									<div class="scrollable scrollable-padding" data-plugin-scrollable style="height: 200px;">
										<div class="scrollable-content" style="background: #FFF;">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In nec egestas felis, ut posuere est. Etiam eleifend, lacus in pretium placerat, augue nulla pretium ex, non accumsan est sapien et arcu. In facilisis euismod justo, id ultricies purus efficitur eu. Nullam a commodo turpis. Nam vitae neque tellus. Sed luctus, ante tincidunt placerat vestibulum, mi dui placerat sapien, consectetur posuere nisl sem non odio. Proin eget metus lobortis, tristique diam bibendum, aliquet nisi. Aliquam sed finibus quam, sed lobortis justo. In cursus magna id scelerisque accumsan. Cras eleifend accumsan ligula, in elementum libero bibendum ut. Maecenas tempor faucibus vulputate.</p>
