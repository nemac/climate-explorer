...
<html class="fixed">
	<head>
		...
		<title>Advanced Forms | Porto Admin - Responsive HTML5 Template 1.4.0</title>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Bootstrap Confirmation</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="#">
											<div class="form-group">
												<label class="col-md-3 control-label">Basic Confirmation</label>
												<div class="col-md-6">
													<a href="#" class="btn btn-primary" data-toggle="confirmation">Click me</a>
												</div>
											</div>
						
											<div class="form-group">
												<label class="col-md-3 control-label">Confirmation with Callbacks</label>
												<div class="col-md-6">
													<a href="#" class="btn btn-primary confirmation-callback">Click me</a>
												</div>
											</div>
										</form>
									</div>
