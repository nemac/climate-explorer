...
<html class="fixed">
	<head>
		...
		<title>Nestable | Porto Admin - Responsive HTML5 Template 1.4.0</title>
	...
	<body>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Nestable List</h2>
									<p class="panel-subtitle">Drag & drop hierarchical list with mouse and touch compatibility.</p>
								</header>
		...
		<!-- Specific Page Vendor -->		<script src="assets/vendor/jquery-nestable/jquery.nestable.js"></script>
