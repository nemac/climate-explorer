                    ...
                    <div class="panel-body">
                        <form action="<?= $page_slug ?><? if ($get_edit > 0) echo "?edit=".$get_edit; ?>" method="POST" style="margin:0" name=myform class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <textarea class="form-control" id="source_params" data-plugin-textarea-autosize="" rows="2" name="source_params"><?=$post_source_params?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="switch switch-primary">
                                        <input type="checkbox" name="visible" value="true" data-plugin-ios-switch <? if ($post_visible == 'true') { echo " checked"; } ?>>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-3 col-lg-9">
                                    ...
                                    <? } else { ?>
                                        <button name="add" value="1" onClick="form.submit();" class="btn btn-md btn-primary">Add User</button>
                                    <? } ?>
                                </div>
                            </div>
