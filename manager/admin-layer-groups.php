        ...
        <div class="col-lg-4">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form action="./admin-layer-groups" method="POST" style="margin:0" name=myform class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <ul id="changes"></ul>
                                <select name="lg_layers[]" id="select_layers" multiple class="form-control populate">
                        ...
                        while ($selectrow = mysqli_fetch_array($select)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="./admin-layer-groups?delete=<?= $selectrow['lg_id'] ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">REMOVE</a>
                                </td>
                            </tr>
                            ...
                            while ($selectsubrow = mysqli_fetch_array($selectsub)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="./admin-layer-groups?delete=<?= $selectsubrow['lg_id'] ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">REMOVE</a>
                                    </td>
                                </tr>
                            <? }
                        } ?>
...
<? include 'footer.php'; ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#select_layers").asmSelect({
                    addItemTarget: 'bottom',
                    sortable: true
                });
                // track changes with our own event
                $("#select_layers").change(function(e, data) {
