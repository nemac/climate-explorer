  ...
  <body id="page-fire-regimes" class="page-type-case">
    ...
    <header id="left-header">
      <ul id="case-menu" class="menu orange-menu">
        ...
        <li class="legend">
          <span class="text">Current Drought</span>
        ...
        <li class="legend">
          <span class="text">Commodo Consequat</span>
        ...
        <li class="legend">
          <span class="text">Voluptate Velit Esse</span>
        ...
        <li class="legend">
          <span class="text">Excepteur Sint</span>
