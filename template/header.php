...
<div id="detail-overlay" class="overlay">
    ...
    <div id="variable-details" class="nav-detail">
        ...
        <div id="detail-heating_degree_day_18" class="nav-detail-item">
            ...
            <p><a href="variables.php?id=hdd_65f" class="button bg-trans border-white hover-bg-white">Get started</a><a href="#" class="close-detail button bg-trans border-trans color-white arrow-left">Back</a></p>
        </div>
