              ...
              <div class="how-to-read-conus">
                  ...
                  <div class="d-flex-center">
                      <div class="d-flex-center">
                        ...
                        <div class="d-flex-row d-flex-center w-25">
                          <div class="btn-histobs default-selection d-flex-center border border-1 m-1 rounded-3" data-value="histobs">
                            <div class="inner-histobs ps-3 pe-3 pt-2 pb-2 me-2 rounded-3"></div>
                            Observations
                          </div>
                          <div class="d-flex-center w-100" >
                            <img alt="historical observations example graph" src="/img/about-local-climate-graph-histobs.png" class="img-fluid"/>
                          </div>
                          <div class="d-flex-center w-100" >
