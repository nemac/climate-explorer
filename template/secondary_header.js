...
<nav class="navbar navbar-expand mb-2">
  <div class="container-fluid">
    ...
    <div class="ms-auto d-flex flex-row">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#about-data-dropdown" aria-controls="about-data-dropdown" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        
        <div class="collapse navbar-collapse me-2" id="about-data-dropdown">
          <ul class="navbar-nav">
            <li class="nav-item dropdown rounded-3">
              <a class="nav-link dropdown-toggle" href="#" id="about-data-dropdown-menu-link" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#social-media-dropdown" aria-controls="social-media-dropdown" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        
        <div class="collapse navbar-collapse me-2" id="social-media-dropdown">
          <ul class="navbar-nav">
            <li class="nav-item dropdown rounded-3">
              <a class="nav-link dropdown-toggle" href="#" id="social-media-dropdown-menu-link" role="button" data-bs-toggle="dropdown" aria-expanded="false">
