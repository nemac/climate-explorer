...
<header id="main-header" class="flex-container  padding-default width-100 ">
    <span id="secondary-nav" class="topnav d-flex width-100" >
      <a href="/" class="main-home-logo padding-horizontal d-flex-center" title="The Climate Explorer">
        <i class="fas fa-home"></i>
      </a>

        <div class="main-font-title float-left d-flex-nowrap padding-horizontal">
          <span class="extra-title">The </span>Climate Explorer
        </div>

        <div id="about-widget-wrapper" class="padding-horizontal default-btn-height top-select-wrapper-minor d-flex-center main">
          <div class="share-widget about">
            ...
            <ul class="about">
              ...
              <li>
                <a href="/definitions" id="definitions" class="about-definitions-link">
                  <span class="icon fas fa-book"></span>
                  <span class="a-share-label">Definitions</span>
                </a>
              </li>
              <li>
        ...
        <div id="share-widget-wrapper" class="padding-horizontal default-btn-height top-select-wrapper-minor d-flex-center main">
        ...
        <a href="https://toolkit.climate.gov/" target="_blank" class="main-logo padding-horizontal  d-flex-left" title="U.S. Climate Resilience Toolkit, Climate Explorer">
          <img src="/img/crt-logo-mobile.png" alt="U.S. Climate Resilience Toolkit, Climate Explorer">
        </a>
